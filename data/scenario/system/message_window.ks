;メッセージレイヤの定義
		...
		[position width=984 height=337 top=593 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=603 bold="bold" edge="" shadow=""]
		...
		[position layer="message1" width=984 height=337 top=593 left=20 ]
